...
**3.** Validação: Tente cadastrar uma categoria inexistente (ex: 99). O sistema exibirá um alerta de erro vindo da API.

**4** Exclusão: Selecione uma linha na tabela e clique em "Excluir Item".
